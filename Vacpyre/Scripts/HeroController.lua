...
function HeroController:GatherProperties()

    return
    {
        { name = "collider", type = DatumType.Node },
        { name = "camera", type = DatumType.Node },
        { name = "vacuum", type = DatumType.Node },
...
function HeroController:UpdateJump(deltaTime)
...
function HeroController:UpdateDrag(deltaTime)
...
function HeroController:UpdateMovement(deltaTime)
...
function HeroController:UpdateGrounding(deltaTime)
...
function HeroController:Move(velocity, deltaTime, vertSlideNormalLimit)
...
function HeroController:SetGrounded(grounded)
